...
# numpy.ravel   numpy.ravel(a, order)
...
# numpy.rollaxis(arr, axis, start) 三维翻转
'''
...
# broadcast功能模仿广播机制。 它返回一个对象，该对象封装了将一个数组广播到另一个数组的结果。
...
'''
# umpy.split(ary, indices_or_sections, axis) 该函数沿特定的轴将数组分割为子数组。
'''
ary：被分割的输入数组
